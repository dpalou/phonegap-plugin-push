...
You can see all the changes here: [2.0.0...moodlemobile:v4.0.0-moodle.14](https://github.com/havesource/cordova-plugin-push/compare/2.0.0...moodlemobile:v4.0.0-moodle.14)
...
```sh
cordova plugin add @moodlehq/phonegap-plugin-push@4.0.0-moodle.14
```
